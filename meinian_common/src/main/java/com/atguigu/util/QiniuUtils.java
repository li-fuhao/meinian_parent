...
public class QiniuUtils {
    ...
    public  static String accessKey = "n3lo3OK6l9cZwgP-fSctS_0i2CSaoJizAy_Qzsmg";
    public  static String secretKey = "d0ls0mOE5tgUUQFunyqteytLkqENVjbUTy9ODh2L";
    public  static String bucket = "atguigumeinian1021";
